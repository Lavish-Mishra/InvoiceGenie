"""
Django settings for invoicegenie project.
...
MIDDLEWARE = [
    ...
    "common.middleware.DisableCSPMiddleware",
]



ROOT_URLCONF = "invoicegenie.urls"
...
WSGI_APPLICATION = "invoicegenie.wsgi.application"
